    ...
    <footer className="bg-gray-900 dark:bg-black text-white transition-colors duration-300">
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-4">GIBORA<span className="text-blue-400">ENGINEERING</span></h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/" className="hover:text-blue-400 transition">{t('nav.home')}</Link></li>
              <li><Link href="/services" className="hover:text-blue-400 transition">{t('nav.services')}</Link></li>
              <li><Link href="/contact" className="hover:text-blue-400 transition">{t('nav.contact')}</Link></li>
            </ul>
          </div>
